...
const About = () => {
  ...
  const stats = [
    { number: "6800+", label: "Happy Clients", icon: <Users size={26} />, color: "#ff8a00" },
    { number: "10+", label: "Years Experience", icon: <Award size={26} />, color: "#ff315c" },
    { number: "99.9%", label: "Project Success Rate", icon: <Star size={26} />, color: "#d21cff" },
    { number: "24/7", label: "Dedicated Support", icon: <Headphones size={26} />, color: "#3b4cff" },
  ];

  const coreValues = [
    { icon: <Lightbulb size={24} />, title: "Innovation & Agility", desc: "We constantly adapt to cutting-edge tech stacks to build future-proof digital solutions.", color: "#ff8a00" },
    { icon: <Heart size={24} />, title: "Client-Centric Focus", desc: "Your vision is our blueprint. We work hand-in-hand with you to turn ideas into reality.", color: "#ff315c" },
    { icon: <Shield size={24} />, title: "Uncompromised Quality", desc: "From secure backend architecture to pixel-perfect UI, excellence is embedded in our code.", color: "#d21cff" },
    { icon: <Users size={24} />, title: "Collaborative Growth", desc: "We believe in long-term partnerships, helping startups and enterprises scale sustainably.", color: "#3b4cff" },
  ];

  const coreExpertise = [
    { icon: <Code2 size={24} />, title: "Full-Stack Development", desc: "Robust web applications built using React, Next.js, PHP, and modern databases.", color: "#ff8a00" },
    { icon: <PenTool size={24} />, title: "UI/UX & Branding", desc: "Immersive digital interfaces and visual brand identities designed to captivate users.", color: "#ff315c" },
    { icon: <TrendingUp size={24} />, title: "Digital Growth & SEO", desc: "Data-driven marketing strategies and search engine optimization for maximum reach.", color: "#d21cff" },
    { icon: <Smartphone size={24} />, title: "Mobile Solutions", desc: "High-performance cross-platform mobile apps tailored for Android and iOS.", color: "#3b4cff" },
    { icon: <Shield size={24} />, title: "Enterprise Security", desc: "Advanced security protocols and system vulnerability analysis to protect assets.", color: "#1267ff" },
    { icon: <Database size={24} />, title: "Data Analytics & Cloud", desc: "Scalable cloud deployments and deep analytical insights for smart decisions.", color: "#ff8a00" },
  ];

  const milestones = [
    { year: "2016", title: "Inception & Foundation", desc: "Pixsy Media was founded with a vision to revolutionize digital software services." },
    { year: "2019", title: "Expansion to Enterprise", desc: "Scaled operations, delivering over 500+ custom web and mobile solutions globally." },
    { year: "2023", title: "AI & Next-Gen Tech Integration", desc: "Adopted advanced full-stack architectures, cloud automation, and high-end UI frameworks." },
    { year: "2026", title: "Industry Leader", desc: "Proudly empowering 6800+ satisfied clients with robust digital transformation." },
  ];
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-7 text-lg-start text-center">
              ...
              <h1 className="display-4 fw-bold mb-3">
                Empowering Businesses Through <span className="gradient-text">Digital Excellence</span>
              </h1>
              ...
              <div className="about-hero-actions d-flex justify-content-center justify-content-lg-start gap-3">
            ...
            <div className="col-lg-5" data-aos="zoom-in" data-aos-delay="200">
              <div className="about-hero-card p-4 bg-white shadow-lg rounded-4 border">
                <div className="d-flex align-items-center gap-3 mb-4">
                  <div className="about-card-icon-box bg-warning bg-opacity-10 text-warning p-3 rounded-3">
                    <Briefcase size={28} />
                  </div>
                  <div>
                    <h5 className="fw-bold mb-1">Pixsy Media Agency</h5>
      ...
      <div className="container py-5">
        ...
        <section className="about-mission py-5">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6" data-aos="fade-right">
              ...
              <h2 className="fw-bold display-6 mb-3">Building the Digital Future, <span className="gradient-text">One Project at a Time</span></h2>
              ...
              <div className="row g-3">
                ...
                <div className="col-sm-6">
                  <div className="p-3 bg-white rounded-3 border shadow-sm">
                    ...
                    <p className="text-muted small mb-0">To be a globally recognized benchmark for IT engineering and creativity.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-lg-6" data-aos="fade-left">
              <div className="about-vision-box p-5 bg-gradient rounded-5 text-white position-relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #1e293b, #0f172a)' }}>
        ...
        <section className="about-expertise py-5" id="expertise">
          <div className="text-center mb-5">
            ...
            <h2 className="fw-bold display-6" data-aos="fade-up" data-aos-delay="100">Comprehensive <span className="gradient-text">IT Solutions</span></h2>
        ...
        <section className="about-milestones py-5" id="milestones">
          <div className="text-center mb-5">
            ...
            <h2 className="fw-bold display-6" data-aos="fade-up" data-aos-delay="100">Milestones That <span className="gradient-text">Define Us</span></h2>
          ...
          <div className="row g-4 justify-content-center">
            {milestones.map((m, idx) => (
              <div key={idx} className="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay={idx * 100}>
                <div className="p-4 bg-white shadow-sm rounded-4 border h-150 position-relative">
                  <span className="badge bg-dark text-warning mb-3 px-3 py-1 fw-bold rounded-pill">{m.year}</span>
        ...
        <section className="about-cta text-center p-5 my-5 rounded-5 shadow-sm border bg-light" data-aos="zoom-in">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <h3 className="fw-bold mb-3">Ready to <span className="gradient-text">Transform</span> Your Business?</h3>
